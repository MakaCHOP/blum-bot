...
Automate the Blum Crypto game on your Telegram bot with Blum Bot! This Python tool allows the game to run autonomously, utilizing the pynput and keyboard modules. Designed for Python 3.11.9, it's easy to set up and get started.
...
Make sure you have Python 3.11.9 installed on your system. You can download it from the official [Python website](https://www.python.org/downloads/release/python-3116/).
...
2. **Clone your forked repository**
    ...
    ```sh
    git clone https://github.com/MakaChop/blum-bot.git
    cd blum-bot
    ```
